...
export const profile = {
  ...
  hook: "Nobody hands me a spec. I write my own and get to work.",
  location: "Lehi, Utah, United States",
  tagline:
    "Founder and full-stack engineer with 10+ years turning vague ideas into shipped products, usually as the one deciding what to build in the first place. My roots are in business intelligence and data visualization. These days it's AI: building agents, tool use, and LLM-driven features end to end. I take a fuzzy problem, make it real, and iterate with users until it beats what they imagined.",
  summary: [
    "I do my best work before there's a spec, when someone still has to decide what's worth building. For over a decade I've built data-heavy products: custom d3 dashboards and BI tools early on, full-stack React/TypeScript/Node/Postgres applications since, and lately AI-native features like chat agents with tool use, LLM output governance, and the pipelines that make them trustworthy.",
    "What actually drives me is invention. When I couldn't find a good way to run a data-driven beta-reader program for my upcoming book, I built one (heyjustwrite.com). When I wanted to investigate our databases by asking questions in plain language, I built an AI tool to compose and test the queries. I don't do my best work against PRDs and line-level requirements — I do it by taking an abstract idea, making it real, and refining it shoulder-to-shoulder with the people who'll use it. I've done the same thing with my own money on the line, too. Real Growth Media is my own company, and there I'm the one deciding what gets built.",
...
export const experience: Experience[] = [
  ...
  },
  {
    ...
    location: "Lehi, Utah",
    blurb:
      "My own company: I decide what to build. I bring 13+ years of React, TypeScript, Node.js, and Postgres, plus AI tooling built on OpenAI's APIs, to help ventures get off the ground.",
    current: true,
  },
  {
  ...
  },
  {
    ...
    location: "Lehi, Utah",
    blurb:
      "Led the frontend team and managed a group of engineers rebuilding Weave's scheduling platform from the ground up. Set technical direction, mentored new engineers, and owned the architecture calls, all while delivering scalable, enterprise-class features to 27k+ users with TypeScript, React, Go, Postgres, Kubernetes, and gRPC.",
  },
  {
    company: "Weave HQ",
  ...
  },
  {
    ...
    location: "Lehi, Utah",
    blurb:
      "Took full ownership of frontend architecture for a greenfield platform that displaced Oracle Field Services at a prominent global company, taking it from mock-ups to shipped solutions in days.",
  },
  {
    company: "Numetric",
...
export const schoolAI = {
  ...
  paragraphs: [
    ...
    "A good example of how I work here: Code Quest, a SchoolAI PowerUp I came up with and built myself. It's a Blockly maze game that teaches kids the fundamentals of coding, with an AI co-teacher guiding them through the Model Context Protocol. Nobody assigned it to me. I saw the gap and built something for it. It's the kind of work I look for everywhere: modern engineering in service of real learning.",
  ],
  focus: [
    {
